...
The agent that works where you do - terminal or IDE. Write code, run commands,
automate chores, dig through a repo. Parallel sessions, asks before touching your
shell, and plugs into MCP, skills, hooks, and plugins.
